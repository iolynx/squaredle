...
// TODO switch the order of the loops and change for while
export function generateRandomBoard(rows, cols) {
  const vowels = "AEIOUEAO";
  const consonants = "BCDFGHJKLMNPQRSTVW";
